...
SVC_NAME="actions.runner.l-palette-hospital-appointment.Tatianas-MacBook-Air"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (l-palette-hospital-appointment.Tatianas-MacBook-Air)"
